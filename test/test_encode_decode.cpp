...
inline void TEST_STORE_EXTRACT(int64_t value, unsigned int startbit, unsigned int length, bool is_big_endian, bool is_signed)
{
    // std::cout << "--\n TEST_STORE_EXTRACT(" << value << ", " << startbit << ", " << length << ", " << is_big_endian << ", " << is_signed << ")" << std::endl;
...
inline void TEST_ENCODE_DECODE(float value, unsigned int startbit, unsigned int length, bool is_big_endian, bool is_signed, float factor, float offset)
{
    // std::cout << "--\n TEST_ENCODE_DECODE(" << value << ", " << startbit << ", " << length << ", " << is_big_endian << ", " << is_signed << ", " << factor << ", " << offset << ")" << std::endl;
    uint8_t src_array[8] = {0, 0, 0, 0, 0, 0, 0, 0};
